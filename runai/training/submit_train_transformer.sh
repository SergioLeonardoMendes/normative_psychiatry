#!/bin/bash
seed=2
run_dir="transformer_00000000_abcd"
...
vbm_img=1
num_workers=16
experiment="TRANSFORMER_low_ABCD_00000000"

runai submit \
  --name sgo-transf-abcd-00000000 \
  ...
  --host-ipc \
  --project wds20 \
  --volume /nfs/home/wds20/sergio/anormative_psychiatry:/project \
  --volume /nfs/home/wds20/sergio/project/data/:/data \
  --command -- bash /project/src/bash/start_training.sh \
    python3 /project/src/python/train_transformer.py \
      seed=${seed} \
      run_dir=${run_dir} \
