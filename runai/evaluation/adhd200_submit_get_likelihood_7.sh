#!/bin/bash
seed=2
run_dir="get_likelihood_ADHD200_7"
...
transformer_uri="/project/mlruns/0/0eec80ccae54424cab868254b5b16863/artifacts/final_model"
clinical_dir="/project/data/participants_ADHD200.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-adhd200-7 \
