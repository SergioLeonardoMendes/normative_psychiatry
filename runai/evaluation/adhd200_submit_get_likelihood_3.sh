#!/bin/bash
seed=2
run_dir="get_likelihood_ADHD200_3"
...
transformer_uri="/project/mlruns/0/35b6574d72bc4ba6ab0aeffd872375c4/artifacts/final_model"
clinical_dir="/project/data/participants_ADHD200.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-adhd200-3 \
