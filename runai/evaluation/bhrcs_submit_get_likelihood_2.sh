#!/bin/bash
seed=2
run_dir="get_likelihood_BHRCS_2"
val_list="/project/data/participants_BHRCS.tsv"
...
clinical_dir="/project/data/participants_BHRCS.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-bhrcs-2 \
