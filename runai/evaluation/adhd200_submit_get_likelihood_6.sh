#!/bin/bash
seed=2
run_dir="get_likelihood_ADHD200_6"
...
transformer_uri="/project/mlruns/0/9235ae0b3134441db12eeab8ed71c9c3/artifacts/final_model"
clinical_dir="/project/data/participants_ADHD200.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-adhd200-6 \
