#!/bin/bash
seed=2
run_dir="get_likelihood_ADHD200_1"
...
transformer_uri="/project/mlruns/0/8a31ee99a94844bda45029a2ad8d9fd6/artifacts/final_model"
clinical_dir="/project/data/participants_ADHD200.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-adhd200-1 \
