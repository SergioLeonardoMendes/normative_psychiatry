...
transformer_uri="/project/mlruns/0/a3f557dc7e12435cb0ba7a11d934176a/artifacts/final_model"
clinical_dir="/project/data/participants_ABCD.tsv"
vbm_img=1

runai submit \
  --name sgo-get-likelihood-abcd \
  ...
  --command -- python /project/src/python/get_likelihood.py \
  seed=${seed} \
  run_dir=${run_dir} \
  val_list=${val_list} \
